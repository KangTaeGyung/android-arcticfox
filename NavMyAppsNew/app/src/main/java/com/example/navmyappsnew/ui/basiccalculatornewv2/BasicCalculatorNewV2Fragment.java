...
import com.example.navmyappsnew.ShowMe;
import com.example.navmyappsnew.databinding.FragmentBasiccalculatornewv2Binding;
...
public class BasicCalculatorNewV2Fragment extends Fragment {

    private BasicCalculatorNewV2ViewModel basicCalculatorNewV2ViewModel;
    private FragmentBasiccalculatornewv2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // 뷰모델 연결
        basicCalculatorNewV2ViewModel =
                new ViewModelProvider(this).get(BasicCalculatorNewV2ViewModel.class);

        // 화면과 연결 ( 최신 기술 : findViewById() 대신 사용
        binding = FragmentBasiccalculatornewv2Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        // 카멜표기법으로 뷰의 위젯에 접근할 수 있다.
        final TextView tvOutput = binding.tvOutput;
        // 관찰했다가 textView 내용이 수정되면 자동 반영
        basicCalculatorNewV2ViewModel.getOutput().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
        ...
        // 카멜표기법으로 뷰의 위젯에 접근할 수 있다.
        final TextView tvOutputExpression = binding.tvOutputExpression;
        // 관찰했다가 textView 내용이 수정되면 자동 반영
        basicCalculatorNewV2ViewModel.getOutputExpression().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
            public void onChanged(@Nullable String s) {
                tvOutputExpression.setText(s);
            }
        });
        ...
        tv_output_expression = binding.tvOutputExpression;

        btn_ac = (Button) binding.btnAc;
        btn_question = (Button) binding.btnQuestion;
        btn_pecent = (Button) binding.btnPecent;
        btn_division = (Button) binding.btnDivision;

        btn_number_7 = (Button) binding.btnNumber7;
        btn_number_8 = (Button) binding.btnNumber8;
        btn_number_9 = (Button) binding.btnNumber9;
        btn_multiplication = (Button) binding.btnMultiplication;

        btn_number_4 = (Button) binding.btnNumber4;
        btn_number_5 = (Button) binding.btnNumber5;
        btn_number_6 = (Button) binding.btnNumber6;
        btn_subtract = (Button) binding.btnSubtract;

        btn_number_1 = (Button) binding.btnNumber1;
        btn_number_2 = (Button) binding.btnNumber2;
        btn_number_3 = (Button) binding.btnNumber3;
        btn_plus = (Button) binding.btnPlus;

        btn_number_0 = (Button) binding.btnNumber0;
        btn_period = (Button) binding.btnPeriod;
        btn_equal = (Button) binding.btnEqual;
...
//                tv_output_expression.setText(strExpression);
//                tv_output.setText(strExpression);
                basicCalculatorNewV2ViewModel.setOutput(strExpression);
                basicCalculatorNewV2ViewModel.setOutputExpression(strExpression);
            }
